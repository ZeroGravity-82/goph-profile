...
// Test_run_ReturnsMigratorInitError проверяет, что ошибка создания мигратора возвращается вызывающему коду.
func Test_run_ReturnsMigratorInitError(t *testing.T) {
	// Arrange
